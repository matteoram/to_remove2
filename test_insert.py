...
def test_insert(bloom_filter: BloomFilter2, words_list: List[str], sim_num: int) -> float:
...
if __name__ == "__main__":
    ...
    for i in samples:
        ...
        average_insert_time = test_insert(bloom_filter, words_list, sim_num) / 1e6

        results.append({'sample_size': i, 'average_insert_time': average_insert_time})
